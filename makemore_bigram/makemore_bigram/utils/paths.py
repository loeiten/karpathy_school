...
def get_makemore_bigram_package_dir() -> Path:
    """
    Return the absolute path to the makemore_bigram package.
...
def get_output_dir() -> Path:
    ...
    """
    output_dir = get_makemore_bigram_package_dir().parent.joinpath("output")
